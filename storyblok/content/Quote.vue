    ...
    <blockquote class="text-center lg:mx-auto lg:w-3/5">
      <div class="mt-6 lg:mt-10">
        <p class="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium">
          <svg
            class="absolute top-0 start-0 transform -translate-x-8 -translate-y-8 size-16 text-primary sm:h-24 sm:w-24"
            width="16"
            height="13"
            viewBox="0 0 16 13"
            fill="none"
          ...
          <span class="relative z-10 italic text-gray-800">{{ blok.quote }}</span>
        </p>
      </div>
